...
const FEATURE_DICTIONARY: Record<string, number[]> = {
  // Animals & Speed Domain: [Canine Classification, Speed & Agility, Feline & Predators, Rest & Slumber]
  'canine': [0.96, 0.50, -0.20, -0.10],
  'dog': [0.95, 0.50, -0.20, -0.10],
  'hound': [0.92, 0.60, -0.15, -0.10],
  'puppy': [0.90, 0.40, -0.20, 0.30],
  'pup': [0.90, 0.40, -0.20, 0.30],
  'retriever': [0.95, 0.45, -0.20, 0.20],
  'wolf': [0.90, 0.70, 0.60, -0.30],
  'pack': [0.80, 0.70, 0.50, -0.20],
  'feline': [-0.20, 0.30, 0.95, 0.60],
  'cat': [-0.20, 0.20, 0.92, 0.70],
  'kitten': [-0.20, 0.25, 0.88, 0.85],
  'cheetah': [-0.30, 0.98, 0.95, -0.30],
  'predator': [0.10, 0.85, 0.92, -0.40],
  'bear': [-0.20, -0.60, 0.85, 0.90],
  'grizzly': [-0.20, -0.60, 0.85, 0.90],
  'speedy': [0.10, 0.95, 0.10, -0.20],
  'quick': [0.10, 0.95, 0.10, -0.20],
  'fast': [0.10, 0.95, 0.10, -0.20],
  'chasing': [0.20, 0.90, 0.20, -0.20],
  'running': [0.15, 0.92, 0.15, -0.20],
  'agility': [0.15, 0.90, 0.30, -0.20],
  'lazy': [-0.10, -0.80, 0.10, 0.90],
  'sleeping': [-0.10, -0.85, 0.10, 0.95],
  'napping': [-0.10, -0.85, 0.10, 0.90],
  'resting': [-0.10, -0.80, 0.10, 0.88],
  'slumber': [-0.10, -0.85, 0.10, 0.95],
  'playful': [0.60, 0.50, 0.10, 0.20],
  'swimming': [0.40, 0.50, -0.10, 0.10],
  'water': [0.20, 0.30, -0.10, 0.10],
  'lake': [0.20, 0.30, -0.10, 0.10],
